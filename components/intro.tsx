...
export default function Intro() {
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Vivek Kumar.</span> I'm a{" "}
        <span className="font-bold">front-end developer</span> with over{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/vivek-kumar-438b3a1b9/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/vivekkumar004"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
